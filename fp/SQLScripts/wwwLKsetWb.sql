...
/****** Object:  StoredProcedure [dbo].[wwwLKsetWb]    Script Date: 06/27/2018 09:51:19 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[wwwLKsetWb]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[wwwLKsetWb]
GO
...
CREATE procedure [dbo].[wwwLKsetWb]
	@ID int,
	@Wb_No varchar(50),
	@Ord_No int,
	--@ORG varchar(5),
...
grant execute on [wwwLKsetWb] to [pod]
go
