...
/****** Object:  Table [dbo].[wwwLKWB]    Script Date: 06/25/2018 12:30:31 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[wwwLKWB]') AND type in (N'U'))
DROP TABLE [dbo].[wwwLKWB]
GO
...
CREATE TABLE [dbo].[wwwLKWB](
	...
	[PCS] [int] NULL,
	[T_PAC] [int] NULL,
 CONSTRAINT [PK_wwwLKWB] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
