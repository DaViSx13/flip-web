Ext.define('FPAgent.view.wbs.LoadWBForm', {
	...
	items : [
	{
        xtype: 'filefield',
        name: 'uploadFile',
        fieldLabel: FPAgent.lib.Translate.tr("LoadWBForm.uploadFile.fieldLabel"),//'Файл формата .xls; .xlsx; .csv до 1 Мб.',
        labelWidth: 230,
        msgTarget: 'side',
        allowBlank: false,
        anchor: '100%',
    ...
    },
	{
		xtype:'fieldset',
		name:'uploadcomments',
		html :  FPAgent.lib.Translate.tr("LoadWBForm.uploadcomments.html"),/* ' Загружаемый файл должен быть в формате *.xls, *.xlsx или *.csv, <br>'
        ...
        columnWidth: 0.5,
        title: FPAgent.lib.Translate.tr("LoadWBForm.uploadcomments.title"),//'Правила загрузки файла',
        collapsible: true,
